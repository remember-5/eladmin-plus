...
) ENGINE=InnoDB AUTO_INCREMENT=191 ROW_FORMAT=DYNAMIC COMMENT='代码生成字段信息存储';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 ROW_FORMAT=DYNAMIC COMMENT='代码生成器配置';
...
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='应用管理';
...
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='数据库管理';
...
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='部署管理';
...
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='部署历史管理';
...
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='应用与服务器关联';
...
CREATE TABLE `mnt_server` (
                              ...
                              KEY `idx_ip` (`ip`)
) ENGINE=InnoDB AUTO_INCREMENT=2 ROW_FORMAT=DYNAMIC COMMENT='服务器管理';
...
) ENGINE=InnoDB AUTO_INCREMENT=18 ROW_FORMAT=DYNAMIC COMMENT='部门';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 ROW_FORMAT=DYNAMIC COMMENT='数据字典';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 ROW_FORMAT=DYNAMIC COMMENT='数据字典详情';
...
CREATE TABLE `sys_job` (
                           ...
                           KEY `inx_enabled` (`enabled`)
) ENGINE=InnoDB AUTO_INCREMENT=13 ROW_FORMAT=DYNAMIC COMMENT='岗位';
...
) ENGINE=InnoDB AUTO_INCREMENT=3537 ROW_FORMAT=DYNAMIC COMMENT='系统日志';
...
CREATE TABLE `sys_menu` (
                            ...
                            UNIQUE KEY `uniq_name` (`name`),
                            KEY `inx_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=118 ROW_FORMAT=DYNAMIC COMMENT='系统菜单';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 ROW_FORMAT=DYNAMIC COMMENT='定时任务';
...
CREATE TABLE `sys_quartz_log` (
                                  ...
                                  PRIMARY KEY (`log_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=151 ROW_FORMAT=DYNAMIC COMMENT='定时任务日志';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 ROW_FORMAT=DYNAMIC COMMENT='角色表';
...
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='角色部门关联';
...
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='角色菜单关联';
...
CREATE TABLE `sys_user` (
                            ...
                            KEY `idx_dept_id` (`dept_id`) USING BTREE,
                            KEY `inx_enabled` (`enabled`)
) ENGINE=InnoDB AUTO_INCREMENT=3 ROW_FORMAT=DYNAMIC COMMENT='系统用户';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='岗位关联表';
...
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='用户角色关联';
...
CREATE TABLE `tool_alipay_config` (
                                      ...
                                      PRIMARY KEY (`config_id`) USING BTREE
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='支付宝配置类';
...
CREATE TABLE `tool_email_config` (
                                     ...
                                     PRIMARY KEY (`config_id`) USING BTREE
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='邮箱配置';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 ROW_FORMAT=DYNAMIC COMMENT='本地存储';
...
CREATE TABLE `tool_qiniu_config` (
                                     ...
                                     PRIMARY KEY (`config_id`) USING BTREE
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='七牛云配置';
...
CREATE TABLE `tool_qiniu_content` (
                                      ...
                                      UNIQUE KEY `uniq_name` (`name`)
) ENGINE=InnoDB ROW_FORMAT=DYNAMIC COMMENT='七牛云文件存储';
