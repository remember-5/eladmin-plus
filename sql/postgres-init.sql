...
-- ----------------------------
BEGIN;
INSERT INTO "sys_dept" ("dept_id", "pid", "sub_count", "name", "dept_sort", "enabled", "create_by", "update_by", "create_time", "update_time") VALUES (2, 7, 1, '研发部', 3, 't', 'admin', 'admin', '2019-03-25 09:15:32', '2020-08-02 14:48:47');
INSERT INTO "sys_dept" ("dept_id", "pid", "sub_count", "name", "dept_sort", "enabled", "create_by", "update_by", "create_time", "update_time") VALUES (5, 7, 0, '运维部', 4, 't', 'admin', 'admin', '2019-03-25 09:20:44', '2020-05-17 14:27:27');
INSERT INTO "sys_dept" ("dept_id", "pid", "sub_count", "name", "dept_sort", "enabled", "create_by", "update_by", "create_time", "update_time") VALUES (6, 8, 0, '测试部', 6, 't', 'admin', 'admin', '2019-03-25 09:52:18', '2020-06-08 11:59:21');
INSERT INTO "sys_dept" ("dept_id", "pid", "sub_count", "name", "dept_sort", "enabled", "create_by", "update_by", "create_time", "update_time") VALUES (7, NULL, 2, '华南分部', 0, 't', 'admin', 'admin', '2019-03-25 11:04:50', '2020-06-08 12:08:56');
INSERT INTO "sys_dept" ("dept_id", "pid", "sub_count", "name", "dept_sort", "enabled", "create_by", "update_by", "create_time", "update_time") VALUES (8, NULL, 2, '华北分部', 1, 't', 'admin', 'admin', '2019-03-25 11:04:53', '2020-05-14 12:54:00');
INSERT INTO "sys_dept" ("dept_id", "pid", "sub_count", "name", "dept_sort", "enabled", "create_by", "update_by", "create_time", "update_time") VALUES (15, 8, 0, 'UI部门', 7, 't', 'admin', 'admin', '2020-05-13 22:56:53', '2020-05-14 12:54:13');
INSERT INTO "sys_dept" ("dept_id", "pid", "sub_count", "name", "dept_sort", "enabled", "create_by", "update_by", "create_time", "update_time") VALUES (17, 2, 0, '研发一组', 999, 't', 'admin', 'admin', '2020-08-02 14:49:07', '2020-08-02 14:49:07');
COMMIT;
...
INSERT INTO "sys_dict" ("dict_id", "name", "description", "create_by", "update_by", "create_time", "update_time") VALUES (2, 'app_ver_type', 'app版本类型', 'admin', 'admin', '2022-05-16 11:08:18.455', '2022-05-16 11:08:18.455');
INSERT INTO "sys_dict" ("dict_id", "name", "description", "create_by", "update_by", "create_time", "update_time") VALUES (3, 'platform_type', '系统标识', 'admin', 'admin', '2022-05-16 14:47:55.801', '2022-05-16 14:47:55.801');
COMMIT;
...
INSERT INTO "sys_dict_detail" ("detail_id", "dict_id", "label", "value", "dict_sort", "create_by", "update_by", "create_time", "update_time") VALUES (22, 2, '强制更新', 'forcibly', 1, 'admin', 'admin', '2022-05-16 12:50:42.725', '2022-05-16 12:50:42.725');
INSERT INTO "sys_dict_detail" ("detail_id", "dict_id", "label", "value", "dict_sort", "create_by", "update_by", "create_time", "update_time") VALUES (23, 2, '弹窗确认更新', 'solicit', 999, 'admin', 'admin', '2022-05-16 12:55:57.612', '2022-05-16 12:55:57.612');
INSERT INTO "sys_dict_detail" ("detail_id", "dict_id", "label", "value", "dict_sort", "create_by", "update_by", "create_time", "update_time") VALUES (24, 2, '静默更新', 'silent', 999, 'admin', 'admin', '2022-05-16 12:56:16.373', '2022-05-16 12:56:16.373');
INSERT INTO "sys_dict_detail" ("detail_id", "dict_id", "label", "value", "dict_sort", "create_by", "update_by", "create_time", "update_time") VALUES (28, 3, 'windows', 'windows', 999, 'admin', 'admin', '2022-05-16 14:52:22.434', '2022-05-16 14:52:22.434');
INSERT INTO "sys_dict_detail" ("detail_id", "dict_id", "label", "value", "dict_sort", "create_by", "update_by", "create_time", "update_time") VALUES (27, 3, 'mac', 'mac', 999, 'admin', 'admin', '2022-05-16 14:52:03.868', '2022-05-16 14:52:34.404');
INSERT INTO "sys_dict_detail" ("detail_id", "dict_id", "label", "value", "dict_sort", "create_by", "update_by", "create_time", "update_time") VALUES (26, 3, 'android', 'android', 999, 'admin', 'admin', '2022-05-16 14:49:26.326', '2022-05-16 14:52:40.359');
INSERT INTO "sys_dict_detail" ("detail_id", "dict_id", "label", "value", "dict_sort", "create_by", "update_by", "create_time", "update_time") VALUES (25, 3, 'ios', 'ios', 999, 'admin', 'admin', '2022-05-16 14:48:32.441', '2022-05-16 14:52:45.41');
INSERT INTO "sys_dict_detail" ("detail_id", "dict_id", "label", "value", "dict_sort", "create_by", "update_by", "create_time", "update_time") VALUES (29, 3, 'linux', 'linux', 999, 'admin', 'admin', '2022-05-16 14:52:58.377', '2022-05-16 14:52:58.377');
INSERT INTO "sys_dict_detail" ("detail_id", "dict_id", "label", "value", "dict_sort", "create_by", "update_by", "create_time", "update_time") VALUES (1, 1, '激活', 'true', 1, NULL, 'test', '2019-10-27 20:31:36', '2022-10-09 20:12:26.543');
COMMIT;
...
COMMENT ON COLUMN "sys_log"."channel_id" IS '渠道类型 1=sys 2=app';
...
INSERT INTO "sys_menu" ("menu_id", "pid", "sub_count", "type", "title", "name", "component", "menu_sort", "icon", "path", "i_frame", "cache", "hidden", "permission", "create_by", "update_by", "create_time", "update_time") VALUES (1, NULL, 8, 0, '系统管理', NULL, NULL, 1, 'system', 'system', 'f', 'f', 'f', NULL, NULL, NULL, '2018-12-18 15:11:29', NULL);
...
INSERT INTO "sys_role" ("role_id", "name", "level", "description", "data_scope", "create_by", "update_by", "create_time", "update_time") VALUES (1, '超级管理员', 1, '-', '自定义', NULL, 'admin', '2018-11-23 11:04:37', '2022-05-16 13:04:31.708');
COMMIT;
...
SELECT setval('"app_version_v2_id_seq"', 1, true);
...
SELECT setval('"code_column_config_column_id_seq"', 1, true);
...
SELECT setval('"code_gen_config_config_id_seq"', 1, true);
...
SELECT setval('"m_user_user_id_seq"', 1, true);
...
SELECT setval('"sys_dept_dept_id_seq"', 26, true);
...
SELECT setval('"sys_dict_detail_detail_id_seq"', 29, true);
...
SELECT setval('"t_cms_cms_id_seq"', 1, true);
...
SELECT setval('"t_cms_column_column_id_seq"', 1, true);
...
-- ----------------------------
ALTER TABLE "sys_log" ADD CONSTRAINT "sys_log_pkey" PRIMARY KEY ("log_id");
