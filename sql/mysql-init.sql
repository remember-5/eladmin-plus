...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='代码生成字段信息存储';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='代码生成器配置';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='部署历史管理';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='应用与服务器关联';
...
INSERT INTO `sys_dict` (`dict_id`, `name`, `description`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (6, 'emp_status', '员工状态', 'admin', 'admin', '2024-01-04 18:07:50', '2024-01-04 18:07:50');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dict_detail` (`detail_id`, `dict_id`, `label`, `value`, `dict_sort`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (1, 1, '在职', '1', 1, NULL, 'admin', '2019-10-27 20:31:36', '2024-01-04 18:08:12');
INSERT INTO `sys_dict_detail` (`detail_id`, `dict_id`, `label`, `value`, `dict_sort`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (2, 1, '离职', '9', 2, NULL, 'admin', NULL, '2024-01-04 18:08:19');
...
INSERT INTO `sys_dict_detail` (`detail_id`, `dict_id`, `label`, `value`, `dict_sort`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (7, 1, '外派', '6', 999, 'admin', 'admin', '2024-01-04 18:08:28', '2024-01-04 18:08:28');
INSERT INTO `sys_dict_detail` (`detail_id`, `dict_id`, `label`, `value`, `dict_sort`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (8, 1, '居家', '2', 999, 'admin', 'admin', '2024-01-04 18:09:06', '2024-01-04 18:09:06');
COMMIT;
...
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (120, 36, 4, 1, '存储资源管理', 'ResourcesManagement', 'resources/index', 38, 'dept', 'resourcesManagement', b'0', b'0', b'0', 'resourcesManagement:list', 'admin', 'admin', '2021-04-12 16:27:31', '2021-04-14 09:45:42');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (121, 120, 0, 2, '新增存储对象', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'resourcesManagement:add', 'admin', 'admin', '2021-04-14 11:21:51', '2021-04-14 11:21:51');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (122, 120, 0, 2, '修改存储对象', NULL, NULL, 2, NULL, NULL, b'0', b'0', b'0', 'resourcesManagement:edit', 'admin', 'admin', '2021-04-14 11:22:13', '2021-04-14 11:22:13');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (123, 120, 0, 2, '删除存储对象', NULL, NULL, 3, NULL, NULL, b'0', b'0', b'0', 'resourcesManagement:del', 'admin', 'admin', '2021-04-14 11:22:42', '2021-04-14 11:22:42');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (124, 120, 0, 2, '修改存储对象状态', NULL, NULL, 4, NULL, NULL, b'0', b'0', b'0', 'resourcesManagement:switchs', 'admin', 'admin', '2021-04-14 11:23:15', '2021-04-14 11:23:15');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (137, 41, 0, 2, '踢出在线用户', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'online:del', 'admin', 'admin', '2021-12-10 15:10:11', '2021-12-10 15:54:35');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (138, 7, 0, 2, '清空info日志', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'logs:del', 'admin', 'admin', '2021-12-10 15:52:50', '2021-12-10 15:54:09');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (139, 32, 0, 2, '清空error日志', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'errorlogs:del', 'admin', 'admin', '2021-12-10 15:53:33', '2021-12-10 15:53:33');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (140, 32, 0, 2, '查看error日志详情', NULL, NULL, 1, NULL, NULL, b'0', b'0', b'0', 'errorlogs:details', 'admin', 'admin', '2021-12-10 15:53:56', '2021-12-10 15:53:56');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (141, 14, 0, 2, '配置邮件', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'email:configure', 'admin', 'admin', '2021-12-10 16:09:17', '2021-12-10 16:09:17');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (142, 14, 0, 2, '发送邮件', NULL, NULL, 1, NULL, NULL, b'0', b'0', b'0', 'email:send', 'admin', 'admin', '2021-12-10 16:09:43', '2021-12-10 16:09:43');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (143, 19, 0, 2, '配置支付宝', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'aliPay:configure', 'admin', 'admin', '2021-12-10 16:10:04', '2021-12-10 16:10:04');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (144, 19, 0, 2, '支付宝测试', NULL, NULL, 1, NULL, NULL, b'0', b'0', b'0', 'aliPay:test', 'admin', 'admin', '2021-12-10 16:10:29', '2021-12-10 16:10:29');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (147, 146, 4, 1, 'app版本', NULL, 'appVersion/index', 999, NULL, '/sysSet/appVer', b'0', b'0', b'0', 'version:list', 'test', 'test', '2022-03-02 16:01:26', '2022-03-02 16:07:34');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (148, 147, 0, 2, 'app版本添加', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'version:add', 'test', 'test', '2022-03-02 16:01:26', '2022-03-02 16:01:26');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (149, 147, 0, 2, 'app版本修改', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'version:edit', 'test', 'test', '2022-03-02 16:01:26', '2022-03-02 16:01:26');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (150, 147, 0, 2, 'app版本删除', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'version:del', 'test', 'test', '2022-03-02 16:01:26', '2022-03-02 16:01:26');
INSERT INTO `sys_menu` (`menu_id`, `pid`, `sub_count`, `type`, `title`, `name`, `component`, `menu_sort`, `icon`, `path`, `i_frame`, `cache`, `hidden`, `permission`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (151, 147, 0, 2, 'app版本导入', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'version:importData', 'test', 'test', '2022-03-02 16:01:27', '2022-03-02 16:01:27');
COMMIT;
...
CREATE TABLE `sys_quartz_job` (
  ...
  `is_pause` bit(1) DEFAULT b'0' COMMENT '状态：1暂停、0启用',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='角色部门关联';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`user_id`, `dept_id`, `username`, `nick_name`, `gender`, `phone`, `email`, `avatar_name`, `avatar_path`, `password`, `is_admin`, `enabled`, `create_by`, `update_by`, `pwd_reset_time`, `create_time`, `update_time`) VALUES (1, 2, 'admin', '管理员', '男', '18888888888', '201507802@qq.com', 'avatar-20200806032259161.png', '/Users/jie/Documents/work/me/admin/eladmin/~/avatar/avatar-20200806032259161.png', '$2a$10$nz5y.NQnk50QsUCtgtgjlOqEnnzH.WMzBqiE51FA7C49KcEu3UfG6', b'1', b'1', NULL, 'admin', '2020-05-03 16:38:31', '2018-08-23 09:11:56', '2020-09-05 10:43:31');
INSERT INTO `sys_user` (`user_id`, `dept_id`, `username`, `nick_name`, `gender`, `phone`, `email`, `avatar_name`, `avatar_path`, `password`, `is_admin`, `enabled`, `create_by`, `update_by`, `pwd_reset_time`, `create_time`, `update_time`) VALUES (2, 2, 'test', '测试', '男', '19999999999', '231@qq.com', NULL, NULL, '$2a$10$dBgPJaqznDC/W3xRfyUoPuosqIQqYKOTYHcnjz1F/ydctURcELgaS', b'0', b'1', 'admin', 'admin', NULL, '2020-05-05 11:15:49', '2020-09-05 10:43:38');
COMMIT;
...
CREATE TABLE `tool_alipay_config` (
  ...
  PRIMARY KEY (`config_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='支付宝配置类';
...
CREATE TABLE `tool_email_config` (
  ...
  PRIMARY KEY (`config_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='邮箱配置';
...
CREATE TABLE `tool_qiniu_config` (
  ...
  PRIMARY KEY (`config_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='七牛云配置';
