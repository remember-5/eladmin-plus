/*
 ...
 Source Server         : eladmin_template
 Source Server Type    : MySQL
 Source Server Version : 50728
 Source Host           : 118.25.95.207:3306
 Source Schema         : eladmin_template

 Target Server Type    : MySQL
 Target Server Version : 50728
 File Encoding         : 65001

 Date: 17/01/2022 16:45:41
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='数据字典详情';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统日志';
...
CREATE TABLE `sys_menu` (
  ...
  UNIQUE KEY `uniq_name` (`name`) USING BTREE,
  KEY `inx_pid` (`pid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=145 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统菜单';
...
INSERT INTO `sys_menu` VALUES (7, 6, 1, 1, '操作日志', 'Log', 'monitor/log/index', 11, 'log', 'logs', b'0', b'1', b'0', 'logs:list', NULL, 'admin', '2018-12-18 15:18:26', '2021-12-10 15:48:23');
...
INSERT INTO `sys_menu` VALUES (14, 36, 2, 1, '邮件工具', 'Email', 'tools/email/index', 35, 'email', 'email', b'0', b'0', b'0', NULL, NULL, NULL, '2018-12-27 10:13:09', NULL);
...
INSERT INTO `sys_menu` VALUES (19, 36, 2, 1, '支付宝工具', 'AliPay', 'tools/aliPay/index', 37, 'alipay', 'aliPay', b'0', b'0', b'0', NULL, NULL, NULL, '2018-12-31 14:52:38', NULL);
INSERT INTO `sys_menu` VALUES (21, NULL, 2, 0, '多级菜单', NULL, '', 900, 'menu', 'nested', b'0', b'0', b'1', NULL, NULL, 'admin', '2019-01-04 16:22:03', '2021-12-10 16:14:19');
...
INSERT INTO `sys_menu` VALUES (32, 6, 2, 1, '异常日志', 'ErrorLog', 'monitor/log/errorLog', 12, 'error', 'errorLog', b'0', b'0', b'0', 'errorlogs:list', NULL, 'admin', '2019-01-13 13:49:03', '2021-12-10 15:48:32');
...
INSERT INTO `sys_menu` VALUES (41, 6, 1, 1, '在线用户', 'OnlineUser', 'monitor/online/index', 10, 'Steve-Jobs', 'online', b'0', b'0', b'0', 'online:list', NULL, 'admin', '2019-10-26 22:08:43', '2021-12-10 15:09:37');
...
INSERT INTO `sys_menu` VALUES (120, 36, 4, 1, '存储资源管理', 'ResourcesManagement', 'resources/index', 38, 'dept', 'resourcesManagement', b'0', b'0', b'0', 'resourcesManagement:list', 'admin', 'admin', '2021-04-12 16:27:31', '2021-04-14 09:45:42');
INSERT INTO `sys_menu` VALUES (121, 120, 0, 2, '新增存储对象', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'resourcesManagement:add', 'admin', 'admin', '2021-04-14 11:21:51', '2021-04-14 11:21:51');
INSERT INTO `sys_menu` VALUES (122, 120, 0, 2, '修改存储对象', NULL, NULL, 2, NULL, NULL, b'0', b'0', b'0', 'resourcesManagement:edit', 'admin', 'admin', '2021-04-14 11:22:13', '2021-04-14 11:22:13');
INSERT INTO `sys_menu` VALUES (123, 120, 0, 2, '删除存储对象', NULL, NULL, 3, NULL, NULL, b'0', b'0', b'0', 'resourcesManagement:del', 'admin', 'admin', '2021-04-14 11:22:42', '2021-04-14 11:22:42');
INSERT INTO `sys_menu` VALUES (124, 120, 0, 2, '修改存储对象状态', NULL, NULL, 4, NULL, NULL, b'0', b'0', b'0', 'resourcesManagement:switchs', 'admin', 'admin', '2021-04-14 11:23:15', '2021-04-14 11:23:15');
INSERT INTO `sys_menu` VALUES (125, NULL, 4, 0, '文章管理', NULL, NULL, 999, 'develop', 'cms', b'0', b'0', b'0', NULL, 'admin', 'admin', '2021-11-30 14:54:18', '2021-11-30 14:54:18');
INSERT INTO `sys_menu` VALUES (126, 125, 3, 1, '文章列表', NULL, 'cms/index', 999, NULL, 'cmsIndex', b'0', b'0', b'0', 'cms:list', 'admin', 'admin', '2021-11-30 14:55:17', '2021-11-30 19:42:02');
INSERT INTO `sys_menu` VALUES (127, 125, 0, 1, '文章发布', 'AddCms', 'cms/insert', 999, NULL, 'addCms', b'0', b'0', b'1', 'cms:add', 'admin', 'admin', '2021-11-30 15:18:38', '2021-11-30 18:59:19');
INSERT INTO `sys_menu` VALUES (128, 125, 0, 1, '修改文章', 'EditCms', 'cms/editorCms', 999, NULL, 'editCms', b'0', b'0', b'1', 'cms:edit', 'admin', 'admin', '2021-11-30 15:19:05', '2021-11-30 18:59:30');
INSERT INTO `sys_menu` VALUES (129, 125, 4, 1, '栏目管理', 'CmsColumn', 'column/index', 999, NULL, 'cmsColumn', b'0', b'0', b'0', 'cmsColumn:list', 'admin', 'admin', '2021-11-30 16:44:28', '2021-11-30 19:53:20');
INSERT INTO `sys_menu` VALUES (130, 126, 0, 2, '审核', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'cms:edit', 'admin', 'admin', '2021-11-30 19:11:56', '2021-11-30 19:36:17');
INSERT INTO `sys_menu` VALUES (131, 126, 0, 2, '删除文章', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'cms:del', 'admin', 'admin', '2021-11-30 19:45:46', '2021-11-30 19:45:46');
INSERT INTO `sys_menu` VALUES (132, 126, 0, 2, '新增cms', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'cms:add', 'admin', 'admin', '2021-11-30 19:46:35', '2021-11-30 19:46:54');
INSERT INTO `sys_menu` VALUES (133, 129, 0, 2, '新增顶级栏目', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'cmsColumn:addFirstLevelColumn', 'admin', 'admin', '2021-11-30 19:54:29', '2021-11-30 19:54:29');
INSERT INTO `sys_menu` VALUES (134, 129, 0, 2, '新增栏目', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'cmsColumn:add', 'admin', 'admin', '2021-11-30 19:54:52', '2021-11-30 19:54:52');
INSERT INTO `sys_menu` VALUES (135, 129, 0, 2, '删除栏目', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'cmsColumn:del', 'admin', 'admin', '2021-11-30 19:55:15', '2021-11-30 19:55:15');
INSERT INTO `sys_menu` VALUES (136, 129, 0, 2, '修改栏目', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'cmsColumn:edit', 'admin', 'admin', '2021-11-30 19:55:34', '2021-11-30 19:55:34');
INSERT INTO `sys_menu` VALUES (137, 41, 0, 2, '踢出在线用户', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'online:del', 'admin', 'admin', '2021-12-10 15:10:11', '2021-12-10 15:54:35');
INSERT INTO `sys_menu` VALUES (138, 7, 0, 2, '清空info日志', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'logs:del', 'admin', 'admin', '2021-12-10 15:52:50', '2021-12-10 15:54:09');
INSERT INTO `sys_menu` VALUES (139, 32, 0, 2, '清空error日志', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'errorlogs:del', 'admin', 'admin', '2021-12-10 15:53:33', '2021-12-10 15:53:33');
INSERT INTO `sys_menu` VALUES (140, 32, 0, 2, '查看error日志详情', NULL, NULL, 1, NULL, NULL, b'0', b'0', b'0', 'errorlogs:details', 'admin', 'admin', '2021-12-10 15:53:56', '2021-12-10 15:53:56');
INSERT INTO `sys_menu` VALUES (141, 14, 0, 2, '配置邮件', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'email:configure', 'admin', 'admin', '2021-12-10 16:09:17', '2021-12-10 16:09:17');
INSERT INTO `sys_menu` VALUES (142, 14, 0, 2, '发送邮件', NULL, NULL, 1, NULL, NULL, b'0', b'0', b'0', 'email:send', 'admin', 'admin', '2021-12-10 16:09:43', '2021-12-10 16:09:43');
INSERT INTO `sys_menu` VALUES (143, 19, 0, 2, '配置支付宝', NULL, NULL, 0, NULL, NULL, b'0', b'0', b'0', 'aliPay:configure', 'admin', 'admin', '2021-12-10 16:10:04', '2021-12-10 16:10:04');
INSERT INTO `sys_menu` VALUES (144, 19, 0, 2, '支付宝测试', NULL, NULL, 1, NULL, NULL, b'0', b'0', b'0', 'aliPay:test', 'admin', 'admin', '2021-12-10 16:10:29', '2021-12-10 16:10:29');
INSERT INTO `sys_menu` VALUES (147, 146, 4, 1, 'app版本', NULL, 'appVersion/index', 999, NULL, '/sysSet/appVer', b'0', b'0', b'0', 'version:list', 'test', 'test', '2022-03-02 16:01:26', '2022-03-02 16:07:34');
INSERT INTO `sys_menu` VALUES (148, 147, 0, 2, 'app版本添加', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'version:add', 'test', 'test', '2022-03-02 16:01:26', '2022-03-02 16:01:26');
INSERT INTO `sys_menu` VALUES (149, 147, 0, 2, 'app版本修改', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'version:edit', 'test', 'test', '2022-03-02 16:01:26', '2022-03-02 16:01:26');
INSERT INTO `sys_menu` VALUES (150, 147, 0, 2, 'app版本删除', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'version:del', 'test', 'test', '2022-03-02 16:01:26', '2022-03-02 16:01:26');
INSERT INTO `sys_menu` VALUES (151, 147, 0, 2, 'app版本导入', NULL, NULL, 999, NULL, NULL, b'0', b'0', b'0', 'version:importData', 'test', 'test', '2022-03-02 16:01:27', '2022-03-02 16:01:27');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` VALUES (1, '超级管理员', 1, '-', '自定义', NULL, 'admin', '2018-11-23 11:04:37', '2021-12-10 16:14:58');
INSERT INTO `sys_role` VALUES (2, '普通用户', 2, '-', '本级', NULL, 'admin', '2018-11-23 13:09:06', '2021-12-10 16:13:25');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 2, 'admin', '管理员', '男', '18888888888', '201507802@qq.com', 'avatar.png', 'http://118.25.95.207:9000/eladmin/2021-11-30/a5a676dd-3b31-46d1-a906-4d0cf5762e4d.png', '$2a$10$nz5y.NQnk50QsUCtgtgjlOqEnnzH.WMzBqiE51FA7C49KcEu3UfG6', b'1', 1, NULL, 'admin', '2021-12-09 17:43:28', '2018-08-23 09:11:56', '2021-11-30 18:59:07');
INSERT INTO `sys_user` VALUES (2, 2, 'test', '测试', '男', '19999999999', '231@qq.com', NULL, NULL, '$2a$10$dBgPJaqznDC/W3xRfyUoPuosqIQqYKOTYHcnjz1F/ydctURcELgaS', b'0', 1, 'admin', 'admin', '2021-12-15 14:48:52', '2020-05-05 11:15:49', '2020-09-05 10:43:38');
COMMIT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='岗位关联表';
...
CREATE TABLE `t_cms` (
  `cms_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键ID',
  `agent_id` bigint(20) DEFAULT NULL COMMENT '代理商id',
  `column_id` bigint(20) DEFAULT NULL COMMENT '栏目',
  `title` varchar(255) DEFAULT NULL COMMENT '标题',
  `author` varchar(255) DEFAULT NULL COMMENT '作者',
  `content` text COMMENT '文章内容',
  `cms_status` tinyint(2) DEFAULT NULL COMMENT '文章状态',
  `audit_person` varchar(255) DEFAULT NULL COMMENT '审核人',
  `audit_status` tinyint(2) DEFAULT NULL COMMENT '审核状态',
...
CREATE TABLE `t_cms_column` (
  `column_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键ID',
  `fid` bigint(20) DEFAULT NULL COMMENT '父id',
...
CREATE TABLE `t_resources_management` (
  ...
  `prefix_str` varchar(255) DEFAULT NULL COMMENT '自定义前缀',
  ...
  `is_deleted` tinyint(2) DEFAULT NULL COMMENT '1 表示删除，0 表示未删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uniq_bucket` (`bucket`) USING BTREE COMMENT '字段唯一性'
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='对象存储';
...
CREATE TABLE `m_user`  (
                           ...
                           `ex1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备用字段1',
                           `ex2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备用字段2',
                           `ex3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备用字段3',
                           `ex4` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备用字段4',
                           `ex5` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备用字段5',
                           `create_date` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                           `update_date` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
                           `is_deleted` tinyint(2) NULL DEFAULT NULL COMMENT '1 表示删除，0 表示未删除',
                           PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'API 用户表' ROW_FORMAT = DYNAMIC;
...
(
    ...
    `is_new`       varchar(255)  DEFAULT NULL COMMENT '是否最新 1 历史 0 最新',
    `is_deleted`   tinyint(2) NOT NULL COMMENT '1 表示删除，0 表示未删除。',
    `content`      varchar(1024) DEFAULT NULL COMMENT '升级说明',
    `url`          varchar(255) NOT NULL COMMENT '下载链接',
    `create_date`  tinyint(4) DEFAULT NULL COMMENT '是否最新 1.历史 0 最新',
    `update_date`  datetime      DEFAULT NULL,
    `is_must`      int(1) DEFAULT NULL COMMENT '是否是必须更新',
    `res_type`     int(1) unsigned DEFAULT NULL COMMENT '资源类型 1、app 2、wgt',
    `platform`     int(1) DEFAULT NULL COMMENT '平台 1、ios 2、android',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='App版本';
