...
) ENGINE=InnoDB AUTO_INCREMENT=264 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='代码生成字段信息存储';
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='代码生成器配置';
...
) ENGINE=InnoDB AUTO_INCREMENT=4108 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统日志';
...
CREATE TABLE `sys_menu` (
  ...
  UNIQUE KEY `uniq_name` (`name`) USING BTREE,
  KEY `inx_pid` (`pid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=137 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统菜单';
...
INSERT INTO `sys_menu` VALUES (7, 6, 1, 1, '操作日志', 'Log', 'monitor/log/index', 11, 'log', 'logs', b'0', b'1', b'0', 'logs:list', NULL, 'admin', '2018-12-18 15:18:26', NULL);
...
INSERT INTO `sys_menu` VALUES (32, 6, 2, 1, '异常日志', 'ErrorLog', 'monitor/log/errorLog', 12, 'error', 'errorLog', b'0', b'0', b'0', 'errorlogs:list', NULL, 'admin', '2019-01-13 13:49:03', NULL);
...
INSERT INTO `sys_menu` VALUES (41, 6, 1, 1, '在线用户', 'OnlineUser', 'monitor/online/index', 10, 'Steve-Jobs', 'online', b'0', b'0', b'0', 'online:list', NULL, 'admin', '2019-10-26 22:08:43', NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` VALUES (1, '超级管理员', 1, '-', '自定义', NULL, 'admin', '2018-11-23 11:04:37', '2021-11-30 19:56:18');
INSERT INTO `sys_role` VALUES (2, '普通用户', 2, '-', '本级', NULL, 'admin', '2018-11-23 13:09:06', '2021-11-30 19:51:35');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 2, 'admin', '管理员', '男', '18888888888', '201507802@qq.com', 'avatar.png', 'http://118.25.95.207:9000/eladmin/2021-11-30/a5a676dd-3b31-46d1-a906-4d0cf5762e4d.png', '$2a$10$Egp1/gvFlt7zhlXVfEFw4OfWQCGPw0ClmMcc6FjTnvXNRVf9zdMRa', b'1', 1, NULL, 'admin', '2020-05-03 16:38:31', '2018-08-23 09:11:56', '2021-11-30 18:59:07');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户岗位表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='对象存储';

-- ----------------------------
-- Records of t_resources_management
-- ----------------------------
BEGIN;
INSERT INTO `t_resources_management` VALUES (1, 1, 'elMinlo', 'http://118.25.95.207', 9000, 'eladmin', 'Ideal', 'C8DueiubX461Jc4N', 1, 0, NULL, 0, '模板静态资源 开发环境', '2021-11-30 15:59:41', '2021-11-30 16:46:46', NULL);
COMMIT;
