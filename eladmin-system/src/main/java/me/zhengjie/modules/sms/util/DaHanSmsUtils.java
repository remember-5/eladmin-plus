...
import me.zhengjie.modules.sms.domain.MoObject;
...
public class DaHanSmsUtils {
	...
	private static final String ACCOUNT = "dh94731";
	private static final String PASSWORD = "pwAU3g79";
	...
	public static String BatchSubmit(List<String> phones, String content, String sign) {
		try {
			...
			js.put("password", Encryption.md5Digest(PASSWORD));
