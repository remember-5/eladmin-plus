...
import com.remember5.system.modules.logging.service.impl.SysLogServiceImpl;
...
public class LogAspect {
    ...
    private final SysLogServiceImpl logService;

    ThreadLocal<Long> currentTime = new ThreadLocal<>();

    public LogAspect(SysLogServiceImpl logService) {
