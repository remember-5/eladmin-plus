 ...
 */
package com.remember5.system.modules.tool.websocket.handler;

import cn.hutool.core.util.StrUtil;
import com.remember5.core.constants.CacheKeyConstant;
import com.remember5.core.websocket.NettyProperties;
...
//        super.handlerAdded(ctx);
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        if (msg instanceof FullHttpRequest) {
            ...
            // save redis
            redisTemplate.opsForSet().add(CacheKeyConstant.REDIS_WEB_SOCKET_USER_SET, userid);
            // 鉴权完成删除这个hander
    ...
    public void removeRedisUserId(ChannelHandlerContext ctx){
        ...
        redisTemplate.opsForSet().remove(CacheKeyConstant.REDIS_WEB_SOCKET_USER_SET, userId);
        ctx.channel().close();
    }
