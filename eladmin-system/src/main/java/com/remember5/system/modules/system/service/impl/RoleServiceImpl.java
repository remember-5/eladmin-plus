...
import com.remember5.system.modules.system.mapper.RoleDeptMapper;
import com.remember5.system.modules.system.mapper.RoleMapper;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public void delCaches(Long id, List<User> users) {
        ...
        if (CollectionUtil.isNotEmpty(users)) {
            ...
            redisUtils.delByKeys(CacheKeyConstant.DATA_USER, userIds);
            redisUtils.delByKeys(CacheKeyConstant.MENU_USER, userIds);
            redisUtils.delByKeys(CacheKeyConstant.ROLE_AUTH, userIds);
        }
        redisUtils.del(CacheKeyConstant.ROLE_ID + id);
    }
}
